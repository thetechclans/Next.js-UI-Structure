...
//     setLoading(true);
//     try {
//       const data = await ReferenceService.getMemberStatuses();
//       setStatuses(data);
//     } finally {
//       setLoading(false);
//     }
...
//     if (editStatus) {
//       await ReferenceService.updateMemberStatus({ ...editStatus, ...form });
//     } else {
//       await ReferenceService.createMemberStatus(form as MemberStatus);
//     }
...
//     await ReferenceService.deleteMemberStatus(id);
//     fetchData();
//   };
