...
export default function Home() {
  ...
  return (
    <main className="container mx-auto p-4 space-y-8" dir={dir}>
      <h1 className="text-3xl font-bold text-center">{t("ui_components_demo")}</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold">{t("pagination_component")}</h2>
        <Card>
          <CardContent className="pt-6">
            <Pagination currentPage={currentPage} totalPages={10} onPageChange={setCurrentPage} siblingCount={1} />
          </CardContent>
        </Card>
      </section>

      <section className="space-y-4">
        <h2 className="text-2xl font-semibold">{t("notification_component")}</h2>
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-wrap gap-2">
              <Button onClick={() => handleShowNotification("success")} variant="outline">
                {t("success")}
              </Button>
              <Button onClick={() => handleShowNotification("error")} variant="outline">
                {t("error")}
              </Button>
              <Button onClick={() => handleShowNotification("info")} variant="outline">
                {t("info")}
              </Button>
      ...
      <section className="space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            <Form>
              <FormField label={t("full_name")} placeholder="John Doe" required />
              <FormField
                label={t("email")}
                type="email"
              ...
              />
              <FormField label={t("password")} type="password" placeholder="********" required />
              <FormField
            ...
            <Table>
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className={dir === "rtl" ? "text-left" : "text-right"}>{t("amount")}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className={dir === "rtl" ? "text-left" : "text-right"}>$250.00</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">INV002</TableCell>
                  <TableCell>{t("pending")}</TableCell>
                  <TableCell>PayPal</TableCell>
                  <TableCell className={dir === "rtl" ? "text-left" : "text-right"}>$125.00</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">INV003</TableCell>
                  <TableCell>{t("unpaid")}</TableCell>
                  <TableCell>Bank Transfer</TableCell>
                  <TableCell className={dir === "rtl" ? "text-left" : "text-right"}>$350.00</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+10% {t("from_last_month")}</p>
            </CardContent>
          </Card>
