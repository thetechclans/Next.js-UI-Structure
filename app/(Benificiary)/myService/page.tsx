...
export default function MyServices(data: any): JSX.Element {
...
return (
    <BgSideCard className="w-full overflow-x-hidden items-center " search={false} button={true} title={"Services"}>
