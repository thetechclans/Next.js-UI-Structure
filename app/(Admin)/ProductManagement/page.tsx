...
import { Check, CheckCheck, ChevronDown, Loader2, User } from "lucide-react";
...
export default function ProductManagement(data: any): JSX.Element {
      ...
      >
        ...
        <Form>
          <div className="grid grid-cols-2 gap-4 w-full my-4">
            ...
            <FormField label="Service Type" placeholder="Enter Your Email" />
            <FormField label="Start Date" placeholder="Enter Your Start Date" />
            <FormField label="End Date" placeholder="Enter Your Email" />
            <FormField
              label="Number of beneficiaries"
              placeholder="Enter Your Number of beneficiaries"
            />
          </div>
        </Form>
