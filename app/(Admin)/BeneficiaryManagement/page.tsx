...
export default function BeneficiaryManagement(data: any): JSX.Element {
        ...
        <Form>
          <div className="grid grid-cols-2 gap-4 w-full my-4">
            ...
            <FormField
              ...
              placeholder="Enter Your Nation Id Number"
            />
            <FormField
              label="the Employee"
              placeholder="Enter Your the Employee"
            />
            <FormField
              label="Accomodation"
            ...
            <FormField
              label="Duration Of the Membership"
              placeholder="Enter Your Duration Of the Membership"
            />
