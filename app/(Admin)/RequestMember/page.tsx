...
export default function RequestMember(data: any): JSX.Element {
      ...
      <div className="p-6 space-y-4">
        ...
        >
          <div className="flex items-center justify-between w-[400px]">
            ...
            <Button
              variant={"default"}
              className="bg-gray-600 text-white rounded-md text-[8px]"
            >
              Annual Subscription
            </Button>
          </div>
          <Form>
            ...
            <FormField accept="image/*" label="Upload Image" type="file" />
          </Form>
