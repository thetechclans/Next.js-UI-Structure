...
export default function MemberManagement(data: any): JSX.Element {
  const [dataState, setData] = useState([
    // Initial empty data array
    // This will be populated with fetched data
    {
            code: 1,
            Details_Of_Complaints: "thowfeek",
            Gender: "male",
        ...
        >
          ...
          <Form>
            <div className="grid grid-cols-2 gap-4 w-full my-4">
              ...
              <FormField label="Profession" placeholder="Enter Your Profession" />
              <FormField label="Phone Number" placeholder="Enter Your Phone Number" />
              <FormField label="Nation Id Number" placeholder="Enter Your Nation Id Number" />
              <FormField label="the Employee" placeholder="Enter Your the Employee" />
              <FormField label="Accomodation" placeholder="Enter Your Accomodation" />
              <FormField label="Its Source" placeholder="Enter Your Its Source" />
              <FormField label="Duration Of the Membership" placeholder="Enter Your Duration Of the Membership" />
              <FormField label="Date of Birth" placeholder="DD/MM/YYYY" />
              <FormField label="Bouquet" placeholder="Enter Your Bouquet" />
            </div>
          </Form>
