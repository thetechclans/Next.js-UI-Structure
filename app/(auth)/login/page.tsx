...
export default function Login2Template() {
  ...
  <div className="absolute top-0 left-0 w-16 h-16 border-t-2 border-l-2 border-blue-200 opacity-50 -mt-6 ml-24 rounded-tl-xl" />

  {/* Bottom-Right Decorative Corner */}
  <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-purple-200 opacity-50 -mb-6 mr-24 rounded-br-xl" />

  {/* Your motion div and form content */}
  <motion.div
    initial={{ opacity: 0, x: 0 }}
    animate={{ opacity: 1, x: 0 }}
    transition={{ duration: 0.8, ease: "easeIn", delay: 0.2 }}
    className="w-full max-w-md bg-background p-8 px-10 rounded-xl shadow-2xl"
  >
