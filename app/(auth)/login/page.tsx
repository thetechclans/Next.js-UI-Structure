    ...
    <div className="flex min-h-screen flex-col md:flex-row bg-primary textstyle">
      ...
      <div className="relative flex w-full items-center justify-center ">
        ...
        <motion.div
          ...
          className="flex w-1/2 items-center justify-center bg-background p-8 w-2xs rounded-xl shadow-2xl"
        >
          <Card className=" w-full max-w-md space-y-8">
            ...
            <Form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Link
                ...
                className="text-sm text-textprimary mt-5"
              >
                Forgot password?
              </Link>
              <Button
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button variant="outline" className="h-12 hover:bg-gray-100">
